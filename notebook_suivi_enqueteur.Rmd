...
retravaille <- read.csv("~/Documents/jftardieu/enquete_grandsud/enquete190517_1253_retravaille.csv")
...
o <- over(resultat, zones_trav)
```
Il y **`r nrow(resultat) - nrow(o[o$Code_enque == "sd008",])`** éléments dans la zone de travail et `r nrow(o[o$Code_enque == "sd008",])` éléments  qui ne sont pas dans le bon polygone sur un total de `r nrow(resultat)`  éléments.
...
## Sd010 **(pas encore de point enregistré)**
```{r}
...
# Grand Anse
## Gd001 **(pas encore de point enregistré)**
```{r}
